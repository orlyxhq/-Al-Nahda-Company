...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "النهضة الزراعية والتجارية شركة سعودية متخصّصة في الحلول الزراعية المتكاملة منذ عام ١٩٧٠." },
        ...
        <div className="container-x grid gap-12 py-16 lg:grid-cols-[1.1fr_1fr] lg:py-24">
          <div>
            ...
            <p className="mt-6 max-w-xl text-lg leading-8 text-muted-foreground">
              بدأت النهضة الزراعية والتجارية عام ١٩٧٠ كموزّع محلّي صغير، وتحوّلت اليوم إلى منصّة
